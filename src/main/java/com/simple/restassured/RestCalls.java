...
public class RestCalls 
{
	...
	//@JsonProperty("Agora-Subscription-Key")
	//public static String key = "fc18a09bd4dc4062a6093c788320c639";
	...
	public static Response PostRequest(String uRI, String strJSON)
	{
		...
		RequestSpecification requestSpecification =  RestAssured.given().body(strJSON).queryParam("Agora-Subscription-Key", key);
		requestSpecification.headers("Content-Type","application/json");
